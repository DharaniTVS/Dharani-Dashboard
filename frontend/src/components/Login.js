...
const Login = () => {
  const handleGoogleLogin = () => {
    // Use browser's location object to derive redirect URL dynamically
    ...
    <div className="min-h-screen flex bg-gray-50">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 p-12 flex-col justify-between">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            <h3 className="text-white font-semibold text-lg mb-2">Service Reports</h3>
            <p className="text-indigo-100 text-sm">Upload daily PDF reports and track technician productivity</p>
          </div>
        </div>
        ...
        <Card className="w-full max-w-md p-8 bg-white rounded-2xl border border-gray-200 shadow-xl" data-testid="login-card">
          ...
          <div className="space-y-6">
            <Button
              ...
              className="w-full h-12 bg-white hover:bg-gray-50 text-gray-900 font-semibold rounded-xl border border-gray-300 flex items-center justify-center gap-3 transition-all"
            ...
            <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-4">
              <p className="text-indigo-800 text-sm text-center">
                Only authorized email addresses can access this application. Contact your administrator if you need access.
              </p>
            </div>
          </div>
        </Card>
